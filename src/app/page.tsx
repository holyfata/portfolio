  ...
  return (
    <div className="font-sans w-4xl mx-auto flex flex-col text-xl">
      <header className="flex h-16 justify-center items-center border-b border-gray-200 px-4 shrink-0">
        <h1 className="text-2xl font-semibold mr-10 cursor-pointer" style={{ fontFamily: 'Stardom-Regular' }}>
      ...
      <main className="flex flex-col pt-10 flex-1 px-4">
        <section className="flex flex-row">
          <section className="pr-4 leading-8 text-gray-500 flex-1 break-words" style={{ fontFamily: 'Chubbo-Regular' }}>
            <p style={{ fontFamily: 'Comico-Regular' }}>Hey! I&apos;m HolyFata</p> <br />
            <p className="leading-10">
              Graduated from NJUPT with a major in Biomedical Engineering, and entered 
          ...
          <section className="flex flex-col shrink-0 w-[240]">
            ...
            />
            <ul className='flex flex-row gap-2 mt-4' style={{fontFamily: 'Telma-Light'}}>
              <li className="flex">
                <span className="text-base">Set out first, and make up for whatever is missing along the way.</span>
              </li>
            </ul>
          </section>
        </section>
